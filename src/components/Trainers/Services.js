...
const Services = () => (
  <section css={styles} className="Services" id="Services">
    ...
    <Icon />
    <p>
      Dedicated team of tech enthusiasts transforming businesses through <br />
      innovation. Tailored services, bridging business requirements with
      technical solutions. Trusted technology partner for growth and success in
